...
func slmPolicies(ctx context.Context, es *elasticsearchdriver.Elasticsearch) ([]slmPolicy, error) {
...
func slmPolicyStats(ctx context.Context, es *elasticsearchdriver.Elasticsearch) (map[string]slmPolicy, error) {
