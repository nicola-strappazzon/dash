...
func newHealthCommand(ctx context.Context, opts *command.Options) *cobra.Command {
	return sectionCommand(ctx, opts, "health", "Show cluster health")
}

func renderClusterHealth(ctx context.Context, es *dashboard.Elasticsearch) error {
