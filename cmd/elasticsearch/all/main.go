...
import (
	...
	"github.com/nicola-strappazzon/dash/cmd/elasticsearch/allocation"
	...
	"github.com/nicola-strappazzon/dash/cmd/elasticsearch/settings"
	...
	"github.com/nicola-strappazzon/dash/cmd/elasticsearch/thread"
...
func NewCommand(ctx context.Context, opts *command.Options) *cobra.Command {
	return runner.SectionCommand(ctx, opts, "all", "Show all Elasticsearch dashboard sections", func(ctx context.Context, es *elasticsearch.Elasticsearch) error {
		return Render(ctx, es, opts.Elasticsearch.SnapshotRepository)
	})
}

func Render(ctx context.Context, es *elasticsearch.Elasticsearch, snapshotRepository string) error {
