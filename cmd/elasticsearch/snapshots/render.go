...
func Repository(repository string) runner.RenderFunc {
	return func(ctx context.Context, es *elasticsearchdriver.Elasticsearch) error {
		return Render(ctx, es, repository)
	}
}

func Render(ctx context.Context, es *elasticsearchdriver.Elasticsearch, repository string) error {
