...
type Config struct {
	...
	Username  string
	Password  string
	// InsecureSkipVerify omite la verificación del certificado TLS. Útil para
	// clústeres internos cuyo certificado no incluye SANs.
	InsecureSkipVerify bool
}

const elasticsearchTimeout = 3 * time.Second

func NewElasticsearch(cfg Config) (*Elasticsearch, error) {
